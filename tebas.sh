...
echo
echo
toilet -f future "TEBAS C0P3T.B3RCL4SS" | lolcat
echo
...
echo $green"Author  : C0P3T.B3RCL4SS			"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[@] CYBERHOOD & All Member RABBIT-ST "
echo $red"##########################$green" WELCOME "$red###########################"
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Tengkyu yg udah Make tools C0P3T.B3RCL4SS "
exit
clear
fi
